...
<body>
	...
	<div id="contents" class="container clearfix">
		<section>
			...
			<ul class="mypage">
				...
				<a href="/mypage/offline/offlineMylecture"><li class="sd_nav_li">내 클래스</li></a>
				<sec:authorize access="hasAnyRole('ROLE_TEACHER')">
					<a href="/mypage/offline/list"><li class="sd_nav_li">클래스 관리</li></a>
	...
	$(function() {
		...
		var offlineClassStr = 'offlineSelect,applicationList,offlineJoin,offlineDetailSelect';
		$(offlineClassStr.split(',')).each(function(i, value) {
			if (url.indexOf(value) != -1) {
				url = '/mypage/offline/list';
			}
		});
