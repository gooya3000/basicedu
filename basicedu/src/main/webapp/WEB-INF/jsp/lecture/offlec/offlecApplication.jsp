...
<div class="onlec_mg_list">
	<form id="form" name="form" action="./offlineapplicationadd"
		...
		<table class="onlec_mg_list_table">
			...
			<tr>
				...
				<td class="onlec_mg_list_td"><input type="text"
					name="application_name" id="application_name" value="" maxlength="5" oninput="maxLengthCheck2(this)"
					class="regi_input"></td>
			</tr>
			...
			<tr>
				...
				<td class="onlec_mg_list_td"><input type="text"
					name="application_phone" id="application_phone" value="" maxlength="11" oninput="maxLengthCheck(this)"  onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"
					class="regi_input"></td>
			</tr>
			...
			<tr>
				...
				<td class="onlec_mg_list_td"><textarea
						...
						class="regi_textarea" id="application_introduce" maxlength="1000" oninput="maxLengthCheck(this)"></textarea></td>
			</tr>
			...
			<tr>
				...
				<td class="onlec_mg_list_td">
					...
					<input type="text" name="application_number" value="1"
			...
			<input type="hidden" name="offline_lecture_NO"
				value="${result.offline_lecture_NO}" class="regi_input"
				id="offline_lecture_NO">
